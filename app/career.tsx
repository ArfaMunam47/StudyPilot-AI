...
import {
  ArrowLeft, Compass, Briefcase, DollarSign, TrendingUp, Award,
...
const careers = [
  {
    ...
    outlook: 'Strong growth, 25% increase projected', salary: '$80,000 - $150,000',
  },
  {
    ...
    outlook: 'High demand, 35% growth expected', salary: '$95,000 - $165,000',
  },
  {
    id: '3', title: 'DevOps Engineer', category: 'Technology',
    skills: ['Docker', 'Kubernetes', 'CI/CD', 'Cloud', 'Linux'],
    certifications: ['AWS Certified DevOps', 'CKA'],
    outlook: 'Critical role, 30% growth projected', salary: '$90,000 - $160,000',
  },
  {
    id: '4', title: 'AI/ML Engineer', category: 'Technology',
    skills: ['Python', 'TensorFlow', 'PyTorch', 'Deep Learning'],
    certifications: ['Google ML Engineer', 'AWS ML Specialty'],
    outlook: 'Explosive growth in AI sector', salary: '$100,000 - $180,000',
  },
];

export default function CareerToolScreen() {
      ...
      <View style={[styles.container, { backgroundColor: bg }]}>
        ...
        <ScrollView style={styles.detailContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={[styles.sectionCard, { backgroundColor: cardBg }]}>
            ...
            {[
              'Build foundational knowledge', 'Develop core technical skills', 'Complete hands-on projects',
              'Earn relevant certifications', 'Build portfolio and network', 'Apply for internships/entry roles',
            ].map((step, i) => (
          ...
          {careers.map((career, index) => (
            <Animated.View key={career.id} entering={FadeInUp.delay(index * 100).duration(400)}>
              <TouchableOpacity style={[styles.careerCard, { backgroundColor: cardBg }]} onPress={() => setSelectedCareer(career.id)}>
                ...
                <Compass size={20} color={textMuted} />
              </TouchableOpacity>
            </Animated.View>
          ))}
        </View>
